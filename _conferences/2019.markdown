...
{:class="w3-center"}
![Department of Defence](/assets/img/sponsors/dod.png){:width="30%"}
![RGB Assurance](/assets/img/sponsors/rgb_assurance.png){:width="35%"}
