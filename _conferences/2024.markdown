...
{:class="w3-center"}
[![KJR](/assets/img/sponsors/kjr.png){:width="25%"}{:class="w3-padding"}{:style="min-width:200px;"}](https://kjr.com.au/){:target="_blank"}
[![ACS](/assets/img/sponsors/acs.png){:width="25%"}{:class="w3-padding"}{:style="min-width:250px;"}](https://www.acs.org.au/){:target="_blank"}
[![SECedu](/assets/img/sponsors/sec_edu.png){:width="15%"}{:class="w3-padding"}{:style="min-width:150px;"}](https://www.sec.edu.au/){:target="_blank"}
[![Hitachi](/assets/img/sponsors/hitachi.png){:width="20%"}{:class="w3-padding"}{:style="min-width:200px;"}](http://www.hitachirail.com/){:target="_blank"}
